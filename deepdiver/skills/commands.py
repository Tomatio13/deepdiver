...
- deepdiver skills list --agent <agent> [--project]
- deepdiver skills create <name>
- deepdiver skills info <name>
"""
...
from deepdiver.config import COLORS, console
from deepdiver.skills.load import list_skills
from deepdiver.skills.paths import (
...
def _list(agent: str, *, project: bool = False) -> None:
    ...
    if project:
        ...
        if not project_skills_dir.exists() or not any(project_skills_dir.iterdir()):
            ...
            console.print(
                "\n[dim]Create a project skill:\n  deepdiver skills create my-skill --project[/dim]",
                style=COLORS["dim"],
            )
            return
        ...
        if not skills:
            ...
            console.print(
                "\n[dim]Create your first skill:\n  deepdiver skills create my-skill[/dim]",
                style=COLORS["dim"],
            )
            return
...
def _create(skill_name: str, agent: str, project: bool = False) -> None:
    ...
    if project:
        skills_dir = ensure_project_skills_dir()
        if not skills_dir:
...
"""
    ...
    console.print(
        ...
        f"  nano {skill_md}\n"
        "\n"
        "💡 See examples/skills/ in the deepdiver repo for example skills:\n"
...
def execute_skills_command(args: argparse.Namespace) -> None:
    ...
    if args.skills_command == "list":
        ...
        console.print("  deepdiver skills <command> [options]\n")
        ...
        console.print("  deepdiver skills list")
        console.print("  deepdiver skills create web-research")
        console.print("  deepdiver skills info web-research")
        console.print("\n[dim]For more help on a specific command:[/dim]", style=COLORS["dim"])
        console.print("  deepdiver skills <command> --help", style=COLORS["dim"])
